...
struct Symbol
{
    string name;     // 名字：x、arr、person、add
    string typeName; // 类型：integer、real、自定义 record/array 类型名
    string kind;     // 类别：program、variable、function、parameter、temporary
